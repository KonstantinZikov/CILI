...
{
    class BranchEqualAtom: BranchAtom
    {
        public override void Action(Context context)
        {
            var value2 = context.Stack.Pop();
            if (value2.Length != 4)
                throw new CiliRuntimeException("The \"beq\" command use 4-byte values, "
        ...
        public override Atom Create(){return new BranchEqualAtom();}
    }
}
